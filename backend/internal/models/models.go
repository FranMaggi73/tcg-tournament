...
type Player struct {
	...
	Status     string  `json:"status" firestore:"status"` // e.g., "active", "dropped"
...
type Tournament struct {
	...
	Status       string    `json:"status" firestore:"status"` // e.g., "registration", "in_progress", "completed"
}
...
type Round struct {
	...
	Status       string    `json:"status" firestore:"status"` // e.g., "pairing", "playing", "completed"
...
type Match struct {
	...
	WinnerID     string `json:"winnerId" firestore:"winnerId"` // Empty if draw
	Status       string `json:"status" firestore:"status"`     // e.g., "scheduled", "completed"
}
